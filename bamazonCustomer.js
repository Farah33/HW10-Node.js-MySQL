...
var bamazon = {
        ...
        displayTable: function() {
            sql.con.query("SELECT * FROM products", function(err, result, fields) {
                ...
                var data = result[i];
                tables.makeTable.prodList.push([data.itemID, data.product_name, data.department_name, data.price, data.stock_quantity]);
                //}
        ...
        initInq: function(inq) {
            inq.prompt([{
                type: "choices",
                message: "Which product would you like to purchase?? Please enter an itemID \n\n",
                name: "item"
            }]).then(function(data) {
